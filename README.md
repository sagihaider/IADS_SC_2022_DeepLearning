...
Make sure that you test individual subsystems separately before you test the full system- it always helps when you are designing a complex system, makes debugging easier. When you are ready to test on the real time tweets, contact me if you need any help. 
...
* Make Sentiment Analysis working on current issues such **COVID19** or any other live news topic such as **Tokyo Olympics**. 
